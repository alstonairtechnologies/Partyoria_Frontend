...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-button-gradient text-white",
        destructive:
          "bg-destructive text-destructive-foreground",
        outline:
          "border border-brand-purple bg-white text-brand-purple",
        secondary:
          "bg-button-gradient text-white",
        ghost: "bg-button-gradient text-white",
        link: "text-brand-purple underline-offset-4",
      },
      size: {
